...
pub struct MetricsSnapshot {
    ...
    pub sync_response_reorders: u64,
...
pub struct NetworkMetrics {
    ...
    pub sync_response_reorders: AtomicU64,
...
impl Default for NetworkMetrics {
    fn default() -> Self {
        Self {
            ...
            sync_response_reorders: AtomicU64::new(0),
...
impl NetworkMetrics {
    ...
    pub fn snapshot(&self) -> MetricsSnapshot {
        ...
        MetricsSnapshot {
            ...
            sync_response_reorders: self.sync_response_reorders.load(Ordering::Relaxed),
